  ...
  render(props) {
    ...
    return (
      <Fragment>
        <TableRow
          key={id}
          className="DataTickerApi--row"
          onClick={this.handleOpenModal}
        >
          <TableCell className="DataTickerApi--col text-bigger collapsible">
            {rank}
          </TableCell>
                ...
                <div className="DataModal--body-table-wrapper">
                  <div class="DataModal--body-table">
                    <div class="DataModal--body-table-row-header ">
                      <div class="DataModal--body-table-cell-label">USD</div>
                      ...
                      <div class="DataModal--body-table-cell-label">BTC</div>
                      <div class="DataModal--body-table-cell-label">
                        Market Cap
                      </div>
                    </div>
